...
async function loadRecentActivity() {
    try {
        const response = await fetch('/backend/api/admin/recent-activity', {
            method: 'GET',
            headers: {
                'Authorization': 'Bearer ' + getAuthToken(),
                'Content-Type': 'application/json'
...
async function loadUsers(page = 1) {
    try {
        ...
        const response = await fetch(`/backend/api/admin/users?${params}`, {
            method: 'GET',
            headers: {
                'Authorization': 'Bearer ' + getAuthToken(),
                'Content-Type': 'application/json'
...
async function loadLibrary(page = 1) {
    try {
        ...
        const response = await fetch(`/backend/api/admin/books?${params}`, {
            method: 'GET',
            headers: {
                'Authorization': 'Bearer ' + getAuthToken(),
                'Content-Type': 'application/json'
...
async function loadLibraryStats() {
    try {
        const response = await fetch('/backend/api/admin/library-stats', {
            method: 'GET',
            headers: {
                'Authorization': 'Bearer ' + getAuthToken(),
                'Content-Type': 'application/json'
