...
echo "<h1>EduLingua - Poblando Biblioteca Digital</h1>";
...
echo "<hr>";
echo "<p><em>Biblioteca Digital EduLingua - " . date('Y-m-d H:i:s') . "</em></p>";
?>

<!DOCTYPE html>
<html>
<head>
    <title>EduLingua - Biblioteca Digital Setup</title>
    <style>
